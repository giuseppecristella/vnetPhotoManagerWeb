<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="VnetPhotoManager.Web.Account.Login" Async="true" %>
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <div class="checkbox">
                                ...
                                <asp:Label runat="server" AssociatedControlID="RememberMe">Memorizza per i prossimi accessi?</asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
